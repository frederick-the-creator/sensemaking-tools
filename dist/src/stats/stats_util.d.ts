 ...
 */
export declare function getAgreeRate(voteTally: VoteTally, asProbabilityEstimate?: boolean): number;
/**
 ...
 * @returns the actual or estimated agree probability
 */
export declare function getTotalAgreeRate(voteInfo: VoteInfo, asProbabilityEstimate?: boolean): number;
/**
 ...
 */
export declare function getTotalDisagreeRate(voteInfo: VoteInfo, asProbabilityEstimate?: boolean): number;
/**
 ...
 * @returns the actual or estimated disagree probability
 */
export declare function getDisagreeRate(voteTally: VoteTally, asProbabilityEstimate?: boolean): number;
/**
 ...
 */
export declare function getGroupInformedDisagreeConsensus(comment: CommentWithVoteInfo): number;
/**
 ...
 */
export declare function getGroupAgreeProbDifference(comment: CommentWithVoteInfo, group: string): number;
/**
 ...
 */
export declare function getCommentVoteCount(comment: Comment): number;
