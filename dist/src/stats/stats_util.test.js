...
describe("stats utility functions", () => {
    it("should get the agree probability for a given vote tally", () => {
        expect((0, stats_util_1.getAgreeRate)({ agreeCount: 10, disagreeCount: 5, passCount: 5, totalCount: 20 })).toBeCloseTo((10 + 1) / (20 + 2));
    });
    it("should handle vote tallies with zero counts", () => {
        expect((0, stats_util_1.getAgreeRate)({ agreeCount: 0, disagreeCount: 0, totalCount: 0 })).toBeCloseTo(0.5);
        expect((0, stats_util_1.getAgreeRate)({ agreeCount: 0, disagreeCount: 5, totalCount: 5 })).toBeCloseTo(1 / 7);
        expect((0, stats_util_1.getAgreeRate)({ agreeCount: 5, disagreeCount: 0, totalCount: 5 })).toBeCloseTo(6 / 7);
    });
    ...
    it("should get the disagree probability for a given vote tally", () => {
        expect((0, stats_util_1.getDisagreeRate)({ agreeCount: 10, disagreeCount: 5, passCount: 5, totalCount: 20 })).toBeCloseTo((5 + 1) / (20 + 2));
    });
    it("should handle vote tallies with zero counts", () => {
        expect((0, stats_util_1.getDisagreeRate)({ agreeCount: 0, disagreeCount: 0, totalCount: 0 })).toBeCloseTo(0.5);
        expect((0, stats_util_1.getDisagreeRate)({ agreeCount: 0, disagreeCount: 5, totalCount: 5 })).toBeCloseTo(6 / 7);
        expect((0, stats_util_1.getDisagreeRate)({ agreeCount: 5, disagreeCount: 0, totalCount: 5 })).toBeCloseTo(1 / 7);
    });
    it("should get the group informed consensus for a given comment", () => {
