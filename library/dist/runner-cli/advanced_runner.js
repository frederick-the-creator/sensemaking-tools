...
function createMinimalStats(stats, relativeContext = null) {
  if (!relativeContext) relativeContext = new relative_context_1.RelativeContext(stats);
...
function getCommentsWithScores(comments, stats) {
  ...
  return comments.map((comment) => {
    ...
    if (comment.voteInfo) {
      ...
      commentWithScores.passRate = (0, stats_util_1.getTotalPassRate)(
        comment.voteInfo,
        stats.asProbabilityEstimate
      );
      commentWithScores.agreeRate = (0, stats_util_1.getTotalAgreeRate)(
        comment.voteInfo,
        stats.includePasses,
        stats.asProbabilityEstimate
      );
      commentWithScores.disagreeRate = (0, stats_util_1.getTotalDisagreeRate)(
        comment.voteInfo,
        stats.includePasses,
        stats.asProbabilityEstimate
      );
...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const summary = yield (0, runner_utils_1.getSummary)(
    ...
    (0, fs_1.writeFileSync)(
      options.outputBasename + "-summary.json",
