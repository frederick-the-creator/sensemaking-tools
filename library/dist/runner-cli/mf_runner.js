...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const verbatimHelpfulnessScores = yield (0,
    matrix_factorization_1.communityNotesMatrixFactorization)(
      verbatimRatings,
      1,
      options.epochs,
    ...
    const agreeHelpfulnessScores = yield (0,
    matrix_factorization_1.communityNotesMatrixFactorization)(
      agreeRatings,
      1,
      options.epochs,
    ...
    const passHelpfulnessScores = yield (0,
    matrix_factorization_1.communityNotesMatrixFactorization)(
      passRatings,
      1,
      options.epochs,
    ...
    const disagreeHelpfulnessScores = yield (0,
    matrix_factorization_1.communityNotesMatrixFactorization)(
      disagreeRatings,
      1,
      options.epochs,
