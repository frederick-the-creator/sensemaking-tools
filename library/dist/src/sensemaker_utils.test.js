...
<data>
  ...
  it("Should get unique topics from a list of comments", () => {
    expect(
      (0, sensemaker_utils_1.getUniqueTopics)([
  ...
  describe("decimalToPercent", () => {
    it("should convert decimal to percent", () =>
      expect((0, sensemaker_utils_1.decimalToPercent)(0.5)).toEqual("50%"));
    it("should convert decimal to percent with precision", () =>
      expect((0, sensemaker_utils_1.decimalToPercent)(0.55555, 2)).toEqual("55.56%"));
  });
});
describe("executeConcurrently", () => {
  ...
  it("should execute all callbacks and return their results in order", () =>
