...
describe("stats utility functions", () => {
  it("should get the agree probability for a given vote tally", () => {
    expect((0, stats_util_1.getAgreeRate)(new types_1.VoteTally(10, 5, 5), true)).toBeCloseTo(
      (10 + 1) / (20 + 2)
    );
  });
  it("should handle vote tallies with zero counts", () => {
    expect((0, stats_util_1.getAgreeRate)(new types_1.VoteTally(0, 0, 0), true, true)).toBeCloseTo(
      0.5
    );
    expect((0, stats_util_1.getAgreeRate)(new types_1.VoteTally(0, 5), true, true)).toBeCloseTo(
      1 / 7
    );
    expect((0, stats_util_1.getAgreeRate)(new types_1.VoteTally(5, 0), true, true)).toBeCloseTo(
      6 / 7
    );
  });
  it("should get the comment vote count with groups", () => {
    expect(
      (0, stats_util_1.getCommentVoteCount)(
        {
          id: "1",
          text: "hello",
          voteInfo: {
  ...
  it("should get the total agree rate for a given comment", () => {
    expect(
      (0, stats_util_1.getTotalAgreeRate)(new types_1.VoteTally(10, 5, 0), true, false)
    ).toEqual(10 / 15);
  });
  it("should get the group informed consensus for a given comment", () => {
    expect(
      (0, stats_util_1.getGroupInformedConsensus)({
        id: "1",
        text: "comment1",
        voteInfo: {
          0: new types_1.VoteTally(10, 5, 0),
  ...
  it("should get the minimum agree probability across groups for a given comment", () => {
    expect(
      (0, stats_util_1.getMinAgreeProb)(
        {
          id: "1",
          text: "comment1",
          voteInfo: {
  ...
  it("should get the disagree probability for a given vote tally", () => {
    expect(
      (0, stats_util_1.getDisagreeRate)(new types_1.VoteTally(10, 5, 5), true, true)
    ).toBeCloseTo((5 + 1) / (20 + 2));
  });
  it("should handle vote tallies with zero counts", () => {
    expect(
      (0, stats_util_1.getDisagreeRate)(new types_1.VoteTally(0, 0, 0), true, true)
    ).toBeCloseTo(0.5);
    expect((0, stats_util_1.getDisagreeRate)(new types_1.VoteTally(0, 5), true, true)).toBeCloseTo(
      6 / 7
    );
    expect((0, stats_util_1.getDisagreeRate)(new types_1.VoteTally(5, 0), true, true)).toBeCloseTo(
      1 / 7
    );
  });
  it("should get the group informed consensus for a given comment", () => {
    expect(
      (0, stats_util_1.getGroupInformedDisagreeConsensus)({
        id: "1",
        text: "comment1",
        voteInfo: {
          0: new types_1.VoteTally(10, 5, 0),
  ...
  it("should get the minimum disagree probability across groups for a given comment", () => {
    expect(
      (0, stats_util_1.getMinDisagreeProb)({
        id: "1",
        text: "comment1",
        voteInfo: {
  ...
  it("should get the group agree difference for a given comment and group", () => {
    expect(
      (0, stats_util_1.getGroupAgreeProbDifference)(
        {
          id: "1",
          text: "comment1",
          voteInfo: {
