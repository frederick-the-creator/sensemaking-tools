...
describe("Matrix Factorization Tests", () => {
  ...
  it("should perform matrix factorization and return note helpfulness scores", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const numNotes = 3;
      const helpfulnessScores = yield (0, matrix_factorization_1.communityNotesMatrixFactorization)(
        ratings,
        1,
        10,
        0.05
  ...
  it("should handle different numbers of factors", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
        { userId: 0, noteId: 1, rating: 0.5 },
      ...
      const numNotes = 3;
      const helpfulnessScores2 = yield (0,
      matrix_factorization_1.communityNotesMatrixFactorization)(ratings, 2, 10, 0.05);
      const helpfulnessScores3 = yield (0,
      matrix_factorization_1.communityNotesMatrixFactorization)(ratings, 3, 10, 0.05);
  ...
  it("should handle different numbers of epochs", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
        { userId: 0, noteId: 1, rating: 0.5 },
  ...
  it("should handle different numbers of epochs, and multiple learning rates", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
        { userId: 0, noteId: 1, rating: 0.5 },
  ...
  it("should handle all notes having identical ratings", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
  ...
  it("should be okay to have a skipped userId", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
        { userId: 1, noteId: 0, rating: 1.0 },
  ...
  it("should be okay to have a skipped noteId", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
        { userId: 1, noteId: 0, rating: 1.0 },
  ...
  it("should be okay to have skipped noteId and userIds", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const ratings = [
        { userId: 0, noteId: 0, rating: 1.0 },
        { userId: 1, noteId: 0, rating: 1.0 },
