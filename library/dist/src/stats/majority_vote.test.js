...
const majority_vote_1 = require("./majority_vote");
const TEST_COMMENTS = [
  // Everyone Agrees
  {
    id: "1",
    text: "comment1",
    voteInfo: {
      0: new types_1.VoteTally(20, 1, 2),
    },
  },
  // Everyone Disagrees
  {
    ...
    text: "comment2",
    voteInfo: {
      0: new types_1.VoteTally(2, 50, 3),
    },
  },
  // Low Alignment - Split Votes
  {
    ...
    text: "comment3",
    voteInfo: {
      0: new types_1.VoteTally(10, 11, 3),
    },
  },
  // Low Alignment if you ignore pass votes
  {
    id: "4",
    text: "comment4",
    voteInfo: { 0: new types_1.VoteTally(33, 33, 33) },
  },
  // High Uncertainty
  {
    id: "5",
    text: "comment5",
    voteInfo: { 0: new types_1.VoteTally(3, 4, 150) },
  },
  {
    id: "6",
    text: "comment6",
...
describe("MajoritySummaryStats Test", () => {
  it("should get the comments with the most common ground", () => {
    const summaryStats = new majority_vote_1.MajoritySummaryStats(TEST_COMMENTS);
