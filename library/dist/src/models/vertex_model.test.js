...
describe("VertexAI test", () => {
  ...
  describe("generateContent", () => {
    it(
      "should retry on rate limit error and return valid JSON",
      () =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          const result = JSON.parse(
            yield model.callLLM("Some instructions", model.getGenerativeModel())
          );
      ...
      15000
    ); // no luck mocking retry timeout for this test - so letting it run longer for now
    it("should generate valid text", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should generate valid structured data that matches the schema", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should throw an error when generated data does not match the schema", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(() =>
          ...
          `Failed after ${model_util_1.MAX_LLM_RETRIES} attempts: Failed to get a valid model response.`
        );
      }));
  });
});
