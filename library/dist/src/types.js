...
exports.VoteTally =
  exports.Summary =
  exports.SummarizationType =
  exports.CommentRecord =
  exports.SubtopicCategorizedComment =
  exports.TopicCategorizedComment =
  exports.Topic =
  exports.NestedTopic =
  exports.FlatTopic =
    void 0;
 ...
 */
exports.CommentRecord = typebox_1.Type.Union([
  exports.TopicCategorizedComment,
  exports.SubtopicCategorizedComment,
]);
/**
...
(function (SummarizationType) {
  SummarizationType[(SummarizationType["GROUP_INFORMED_CONSENSUS"] = 0)] =
...
class Summary {
  ...
  withoutContents(removeFn) {
    return new Summary(
      this.contents.map((sc) =>
        (0, sensemaker_utils_1.filterSummaryContent)(sc, (sc_) => !removeFn(sc_))
      ),
      this.comments
    );
  }
...
function isGroupVoteTalliesType(data) {
  return (
    Object.keys(data).every((groupName) => typeof groupName === "string") &&
