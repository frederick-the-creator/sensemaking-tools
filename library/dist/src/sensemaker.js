...
class Sensemaker {
  ...
  summarize(comments_1) {
    return __awaiter(
      ...
      function* (
        comments,
        summarizationType = types_1.SummarizationType.AGGREGATE_VOTE,
        topics,
        additionalContext
      ) {
        ...
        const summary = yield (0, summarization_1.summarizeByType)(
  ...
  learnTopics(comments, includeSubtopics, topics, additionalContext, topicDepth) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      // topics.
      const categorizedComments = yield this.categorizeComments(
        comments,
        includeSubtopics,
        topics,
        additionalContext,
