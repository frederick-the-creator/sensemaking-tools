...
class Sensemaker {
    ...
    summarize(comments_1) {
        return __awaiter(this, arguments, void 0, function* (comments, summarizationType = types_1.SummarizationType.AGGREGATE_VOTE, topics, additionalContext) {
            const startTime = performance.now();
            // Categories are required for summarization, this is a no-op if they already have categories.
            comments = yield this.categorizeComments(comments, true, topics, additionalContext, 2);
            const summary = yield (0, summarization_1.summarizeByType)(this.getModel("summarizationModel"), comments, summarizationType, additionalContext);
     ...
     * comments.
     */
    learnTopics(comments, includeSubtopics, topics, additionalContext, topicDepth) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // topics.
            const categorizedComments = yield this.categorizeComments(comments, includeSubtopics, topics, additionalContext, topicDepth);
            const learnedTopics = (0, sensemaker_utils_1.getUniqueTopics)(categorizedComments);
     ...
     */
    categorizeComments(comments, includeSubtopics, topics, additionalContext, topicDepth, theme, factor, prompt_categorise_comments, prompt_learn_factors, prompt_learn_metrics, prompt_learn_themes) {
        return __awaiter(this, void 0, void 0, function* () {
            // const startTime = performance.now();
            ...
            // sync.
            const categorizedComments = yield (0, categorization_1.categorizeCommentsRecursive)(comments, includeSubtopics ? topicDepth || 2 : 1, this.getModel("categorizationModel"), topics, additionalContext, theme, factor, prompt_categorise_comments, prompt_learn_factors, prompt_learn_metrics, prompt_learn_themes);
