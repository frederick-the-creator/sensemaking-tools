...
describe("SensemakerTest", () => {
  ...
  describe("CategorizeTest", () => {
    it("should batch comments correctly", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const actualComments = yield new sensemaker_1.Sensemaker(
          TEST_MODEL_SETTINGS
        ).categorizeComments(comments, includeSubtopics, topics, undefined);
  ...
  describe("TopicModelingTest", () => {
    it.skip("should retry topic modeling when the subtopic is the same as a main topic", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const comments = [
        ...
        const commentRecords = yield new sensemaker_1.Sensemaker(TEST_MODEL_SETTINGS).learnTopics(
          comments,
          includeSubtopics,
          undefined
        );
    ...
    it.skip("should retry topic modeling when a new topic is added", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const comments = [
          { id: "1", text: "Comment about Roads" },
          { id: "2", text: "Another comment about Roads" },
