...
exports.RelativeContext = void 0;
...
class RelativeContext {
    constructor(topicStats) {
        ...
        const highAgreementRatePerSubtopic = subtopicStats.map((subtopicStats) => this.getHighAgreementRate(subtopicStats.summaryStats));
        this.averageHighAgreeRate =
            highAgreementRatePerSubtopic.reduce((sum, num) => sum + num, 0) /
                highAgreementRatePerSubtopic.length;
        this.highAgreeStdDeviation = (0, stats_util_1.getStandardDeviation)(highAgreementRatePerSubtopic);
        ...
        this.maxVoteCount = subtopicStats
            ...
            .reduce((a, b) => Math.max(a, b), 0);
        const engagementBySubtopic = subtopicStats.map((subtopicStats) => this.getEngagementNumber(subtopicStats.summaryStats));
        this.engagementStdDeviation = (0, stats_util_1.getStandardDeviation)(engagementBySubtopic);
...
exports.RelativeContext = RelativeContext;
