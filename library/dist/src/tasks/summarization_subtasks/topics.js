  ...
  getSummary() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const nSubtopics = topicStats
        .map((t) => {
          var _a;
          return ((_a = t.subtopicStats) === null || _a === void 0 ? void 0 : _a.length) || 0;
        })
        .reduce((n, m) => n + m, 0);
...
class TopicSummary extends recursive_summarization_1.RecursiveSummary {
  ...
  getSummary() {
    return __awaiter(this, void 0, void 0, function* () {
      var _a;
      const nSubtopics =
        ((_a = this.topicStat.subtopicStats) === null || _a === void 0 ? void 0 : _a.length) || 0;
      if (nSubtopics == 0) {
  ...
  getAllSubTopicSummaries() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const subtopicSummaryContents = yield (0, sensemaker_utils_1.executeConcurrently)(
        subtopicSummaries
      );
      ...
      if (nSubtopics > 0) {
        ...
        const subtopicSummaryPrompt = (0, sensemaker_utils_1.getAbstractPrompt)(
  ...
  getCommentSummary() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (process.env["SKIP_COMMON_GROUND_AND_DIFFERENCES_OF_OPINION"] !== "true") {
        ...
        const differencesOfOpinionSummary = yield this.getDifferencesOfOpinionSummary(
          commonGroundSummary,
          this.topicStat.name
        );
  ...
  getDifferencesOfOpinionSummary(commonGroundSummary, topic) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (nComments === 0) {
        ...
        const prompt = (0, sensemaker_utils_1.getAbstractPrompt)(
          nComments === 1
