...
describe("AllTopicsSummaryTest", () => {
    beforeEach(() => {
        ...
        mockDifferencesSummary = jest.spyOn(topics_1.TopicSummary.prototype, "getDifferencesOfOpinionSummary");
    ...
    it("should create a properly formatted topics summary", () => __awaiter(void 0, void 0, void 0, function* () {
        // Mock the LLM calls
        mockThemesSummary.mockReturnValue(Promise.resolve({
            text: "Themes were...",
        }));
        mockCommonGroundSummary.mockReturnValue(Promise.resolve({
            text: "Some points of common ground...",
            title: "Common ground between groups: ",
        }));
        mockDifferencesSummary.mockReturnValue(Promise.resolve({
            text: "Areas of disagreement between groups...",
            title: "Differences of opinion: ",
        }));
        expect(yield new topics_1.AllTopicsSummary(new group_informed_1.GroupedSummaryStats(TEST_COMMENTS), new vertex_model_1.VertexModel("project123", "usa")).getSummary()).toEqual({
            title: "## Topics",
