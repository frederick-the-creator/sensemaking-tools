...
class GroupsSummary extends recursive_summarization_1.RecursiveSummary {
  ...
  getGroupComparison(groupNames) {
    ...
    const groupComparisonSimilar = this.model.generateText(
      (0, sensemaker_utils_1.getPrompt)(
        ...
        topAgreeCommentsAcrossGroups.map((comment) => comment.text),
    ...
    const groupComparisonDifferent = this.model.generateText(
      (0, sensemaker_utils_1.getPrompt)(
        ...
        topDisagreeCommentsAcrossGroups.map((comment) => comment.text),
        this.additionalContext
      )
    );
  ...
  getGroupDescriptions(groupNames) {
    return __awaiter(this, void 0, void 0, function* () {
          ...
          this.model
            .generateText(
              (0, sensemaker_utils_1.getPrompt)(
                ...
                topCommentsForGroup.map((comment) => comment.text),
                this.additionalContext
              )
            )
            .then((result) => {
      ...
      return (0, sensemaker_utils_1.executeConcurrently)([
        ...groupDescriptions,
