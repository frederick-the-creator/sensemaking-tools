...
class OverviewSummary extends recursive_summarization_1.RecursiveSummary {
  ...
  getTopicNameAndCommentPercentage(topicStats) {
    ...
    const percentage = (0, sensemaker_utils_1.decimalToPercent)(
      topicStats.commentCount / totalCommentCount,
      0
    );
...
function filterSectionsForOverview(topicSummary) {
  return (0, sensemaker_utils_1.filterSummaryContent)(topicSummary, (subtopicSummary) => {
    var _a, _b;
    return (
      !((_a = subtopicSummary.title) === null || _a === void 0
        ? void 0
        : _a.includes("Common ground")) &&
      !((_b = subtopicSummary.title) === null || _b === void 0
        ? void 0
        : _b.includes("Differences of opinion"))
    );
  });
}
/**
